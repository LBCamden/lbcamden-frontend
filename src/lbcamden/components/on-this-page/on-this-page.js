// export default function LBCamdenOnThisPage ($module) {
//   this.$module = $module
// }

// LBCamdenOnThisPage.prototype.init = function () {
//   if (!this.$module) {
//     return
//   }
...
//   this.$module.classList.add('lbcamden-on-this-page--loaded')
// }

// LBCamdenOnThisPage.prototype.showActiveGuide = function ({ handleNotFound } = {}) {
...
// LBCamdenOnThisPage.prototype.setPagination = function ({ next, prev }) {
...
// LBCamdenOnThisPage.prototype.setArticleVisibility = function (article, visible, { setPagination, setContent, setHeading, hiddenAttr } = {}) {
...
// LBCamdenOnThisPage.prototype.getArticles = function () {
//   return Array.from(this.$module.querySelectorAll('[data-guide-article]'))
// }

// LBCamdenOnThisPage.prototype.getActiveItem = function () {
...
// LBCamdenOnThisPage.prototype.getPaginationTargets = function () {
//   return [
...
// LBCamdenOnThisPage.prototype.getNotFoundArticle = function () {
