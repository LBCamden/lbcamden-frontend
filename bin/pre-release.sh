...
if [[ -n $(git status --porcelain) ]]; then
  ...
  git commit -m "Release CAMDEN.GOV.UK Frontend to '$BRANCH_NAME' for testing"
...
echo
echo "✅ Success! To install the pushed branch release, run 'npm install --save \"lbcamden/lbcamden-frontend#$BRANCH_COMMIT_SHA\"'"
